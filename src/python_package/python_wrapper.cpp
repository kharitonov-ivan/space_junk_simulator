...
extern "C"
void main_(const double* x, const double* y, const double* z,
           const double* vx, const double* vy, const double* vz,
           double* x_res, double* y_res, double* z_res,
           double* vx_res, double* vy_res, double* vz_res, size_t simulate_steps, float timestep, bool use_gpu = false) {
